...
import 'package:search_app/Controller/geo.dart';
...
class SearchExample {
  ...
  SearchExample(ShowDialogFunction showDialogCallback,
    ...
    GeoLocationNow().getCurrentPosition().then((value) {
      print(value!.latitude);
      print(value.longitude);
      _camera.lookAtPointWithMeasure(
          GeoCoordinates(value.latitude, value.longitude), mapMeasureZoom);
    });
...
//     var geoNow = GeoLocationNow();
//     var location = await geoNow.getCurrentPosition();
//     return location;
//   }
